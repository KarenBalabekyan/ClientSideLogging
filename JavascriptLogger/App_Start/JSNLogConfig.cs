...
[assembly: WebActivatorEx.PostApplicationStartMethod(
    typeof(JavascriptLogger.App_Start.JSNLogConfig), "PostStart")]

namespace JavascriptLogger.App_Start {
    public static class JSNLogConfig {
        public static void PostStart()
        {
            ...
            {
                Constraints = new RouteValueDictionary { { "jsnloglogger", @"jsnlog\.logger(/.*)?" } }
            };
